...
('b4a3f3d0-dad5-4c97-a022-3e4ac18498b4', 'sophie.miller', '$2b$12$Dc8X0UZTY6GV7A8nsGQzJumyy0LZr/f3YInCv6PbPJo2t1m7JeH3i', 'sophie.miller@example.com', '/avatars/sophie.png'),
('e0284737-9f11-4f80-a732-8fae9fcd7ebd', 'vintage.dan', '$2b$12$V1FgU0a6qChS/E5o6N3eZekjUFeUIZ9F3VvRxUgIh88Hc53V3ENPu', 'dan.vintage@example.com', '/avatars/dan.jpg'),
('87c8c198-3a1f-4264-9014-42caa723b313', 'marina_kolov', '$2b$12$1ml2v0ljd54Z7WZxsqW0xe0fVOsMQLS6wNvHTDtxjzOaEfRogvy6G', 'marina.kolov@example.org', NULL),
('cabfab2b-18cb-4f92-bd4a-b586c7985eac', 'collector.lee', '$2b$12$7O2U19CzRL9jPQZKwjE8HeuI.4A2xJ7g/xeZf6ULzDuMtfzWmDvZK', 'lee.c@example.net', '/avatars/lee.png'),
('56d7d61e-0d4c-4d39-8860-6f46f435f2ea', 'ana_gomez', '$2b$12$3R0zYozuqZGxWkwJ2KR0neZKhUkU0dfM9OD0KTu9xquUs9Y92XZra', 'ana.g@example.com', NULL);

-- ITEMS
INSERT INTO items (id, name, type, description, production_year, country, condition, image_path) VALUES
('27430c82-74fc-44a2-a354-c2692c2e7fa3', 'Napoleon III Coin', 'coin', 'French 10 Francs gold coin minted in 1862.', 1862, 'France', 'good', '/images/napoleon_coin.jpg'),
('98138a54-0a3d-42b0-bc80-4b893e1a36ef', 'Ming Dynasty Vase', 'antique', 'Porcelain vase from early Ming dynasty.', 1420, 'China', 'excellent', '/images/ming_vase.jpg'),
('8b6c593f-3e68-44b0-8c3b-7a8e3d15c874', 'Ancient Greek Tetradrachm', 'coin', 'Silver coin featuring Alexander the Great.', 320, 'Greece', 'fair', '/images/tetradrachm.jpg'),
('1e6a980f-cc0e-4ba5-bc53-37b1ffb1425b', 'Art Nouveau Clock', 'antique', 'Handcrafted brass clock from 1905.', 1905, 'Belgium', 'good', '/images/nouveau_clock.jpg'),
('f340bf09-e054-4f6f-bb0a-77022c15d88a', 'Byzantine Cross Pendant', 'antique', 'Bronze cross from Byzantine Empire.', 780, 'Turkey', 'poor', '/images/byzantine_cross.jpg');
